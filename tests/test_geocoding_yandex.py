"""Tests for Yandex geocoding helpers."""
...
from src.geocoding_yandex import build_query_variants, geocode_bakery_row
...
def test_geocode_bakery_row_returns_failed_shape_when_all_attempts_fail(monkeypatch):
    ...
    monkeypatch.setattr("src.geocoding_yandex.geocode_query_yandex", _boom)
    row = pd.Series(
        {
            "bakery_id": "bakery_1",
