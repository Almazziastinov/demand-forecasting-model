...
DATA_PATH = 'data/processed/preprocessed_data_3month.csv'
N_TRIALS  = 50
...
def main():
    ...
    test_df.to_csv('reports/v5_predictions.csv', index=False, encoding='utf-8-sig')
    print("\nПредсказания сохранены в reports/v5_predictions.csv")
    print("\nГотово!")
