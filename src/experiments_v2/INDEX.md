...
В отличие от `REGISTRY.md`, этот файл не оценивает качество экспериментов.
Он отвечает на более простой вопрос: какие каталоги реально существуют и какими
артефактами они заполнены.
...
- [README.md](README.md) - общий обзор папки `experiments_v2`
- [HYBRID_RESEARCH_PLAN.md](HYBRID_RESEARCH_PLAN.md) - исследовательский план гибридной модели и router-подхода

## How To Use This File

- Если нужен рабочий готовый эксперимент с типовыми артефактами, начинать с `completed`
- Если нужен последний незавершённый исследовательский след, смотреть `partial`
